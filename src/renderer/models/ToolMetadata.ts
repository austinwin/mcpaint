...
export const TOOL_META: ToolMeta[] = [
  { type: ToolType.RectSelect, name: 'Rectangle Select', shortcut: 'S', description: 'Select a rectangular region', category: SEL, icon: 'rectSelect', implemented: true, statusHelp: 'Rectangle Select (S): Select a rectangular region of the image.', options: [] },
  ...
  { type: ToolType.Lasso, name: 'Lasso Select', shortcut: 'L', description: 'Select a freeform region', category: SEL, icon: 'lasso', implemented: true, statusHelp: 'Lasso Select (L): Draw a freeform selection outline.', options: [] },
  { type: ToolType.EllipseSelect, name: 'Ellipse Select', shortcut: '', description: 'Select an elliptical region', category: SEL, icon: 'ellipseSelect', implemented: true, statusHelp: 'Ellipse Select: Select an elliptical or circular region.', options: [] },
  { type: ToolType.MagicWand, name: 'Magic Wand', shortcut: 'W', description: 'Select areas of similar color', category: SEL, icon: 'magicWand', implemented: true, statusHelp: 'Magic Wand (W): Select connected areas of similar color. Adjust tolerance for range.', options: ['tolerance'] },
  ...
  { type: ToolType.Text, name: 'Text', shortcut: 'T', description: 'Add text to the image', category: UTL, icon: 'text', implemented: true, statusHelp: 'Text (T): Click to place text. Type and press Enter to commit. Press Esc to cancel.', options: ['size'] },
  { type: ToolType.Line, name: 'Line / Curve', shortcut: 'O', description: 'Draw a straight line', category: SHP, icon: 'line', implemented: true, statusHelp: 'Line / Curve (O): Click and drag to draw a straight line.', options: ['size'] },
  ...
  { type: ToolType.Rect, name: 'Rectangle', shortcut: '', description: 'Draw a rectangle', category: SHP, icon: 'rect', implemented: true, statusHelp: 'Rectangle: Click and drag to draw a rectangle. Use fill mode to change style.', options: ['size', 'fillMode'] },
  { type: ToolType.RoundRect, name: 'Rounded Rect', shortcut: '', description: 'Draw a rounded rectangle', category: SHP, icon: 'roundRect', implemented: true, statusHelp: 'Rounded Rectangle: Draw a rectangle with rounded corners. Adjust corner radius.', options: ['size', 'fillMode', 'radius'] },
  { type: ToolType.Ellipse, name: 'Ellipse', shortcut: '', description: 'Draw an ellipse or circle', category: SHP, icon: 'ellipse', implemented: true, statusHelp: 'Ellipse: Click and drag to draw an ellipse. Hold Shift for a circle.', options: ['size', 'fillMode'] },
